...
# Audio configuration
PRODUCT_COPY_FILES += \
	$(LOCAL_PATH)/audio/apdr.conf:system/etc/apdr.conf \
...
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/wifi/wfdconfig.xml:system/etc/wfdconfig.xml \
    $(LOCAL_PATH)/wifi/wfdconfigsink.xml:system/etc/wfdconfigsink.xml \
