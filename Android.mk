...
$(LOCAL_BUILT_MODULE): WLAN_MAC_BIN_SYMLINK := $(TARGET_OUT_VENDOR)/firmware/wlan/prima/wlan_mac.bin
...
$(LOCAL_BUILT_MODULE):
	...
	$(hide) rm -rf $(WLAN_MAC_BIN_SYMLINK)
	$(hide) ln -sf $(ACTUAL_MAC_BIN_FILE) $(WLAN_MAC_BIN_SYMLINK)
